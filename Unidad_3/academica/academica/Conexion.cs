...
namespace academica {
    internal class Conexion {
        ...
        public String administrarAlumnos(String[] alumnos, String accion) {
            String sql = "";
            if (accion == "nuevo") {
                sql = "INSERT INTO alumnos (codigo,nombre,edad,genero,nota_parcial,nota_lab1,nota_lab2,promedio) VALUES('" + alumnos[1] +"'," + "'"+ alumnos[2] +"', '"+ alumnos[3] +"', '"+ alumnos[4] +"', '"+ alumnos[5] + "', '" + alumnos[6] + "', '" + alumnos[7] + "', '" + alumnos[8] + "')";
            }else if (accion == "modificar") {
                sql = "UPDATE alumnos SET codigo='" + alumnos[1] + "'," +
                    "nombre='" + alumnos[2] + "', edad='" + alumnos[3] + "', genero='" + alumnos[4] + "', nota_parcial='" + alumnos[5] + "', nota_lab1'" + alumnos[6] + "', nota_lab2 '" + alumnos[7] + "',promedio '" + alumnos[8] + "'" + "WHERE idAlumno='"+ alumnos[0] +"'";
